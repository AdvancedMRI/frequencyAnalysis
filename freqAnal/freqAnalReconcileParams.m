function [newparams,newdata] = freqAnalReconcileParams(groupName,params,data)
% params = freqAnalReconcileParams(groupName,[params],[data])
%
% Checks for consistency between freqAnal parameters and current status of
...
%
% params: Optional initial parameters (see freqAnal).
