function varargout = freqAnalGUI(varargin)
% params = freqAnalGUI('groupName',groupName,'params',params)
% params = freqAnalGUI('groupName',groupName);
% params = freqAnalGUI('params',params);
% 
% Creates a new freqAnal GUI.
...
% params = freqAnalGUI('params',params);
% params = freqAnalGUI('groupName','Raw','params',params);
%
% djh, 7/2004

% Last Modified by GUIDE v2.5 20-Nov-2013 12:57:52

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @freqAnalGUI_OpeningFcn, ...
                   'gui_OutputFcn',  @freqAnalGUI_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before freqAnalGUI is made visible.
function freqAnalGUI_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to freqAnalGUI (see VARARGIN)
...
if ieNotDefined('params')
    params = freqAnalReconcileParams(groupName);
else
    params = freqAnalReconcileParams(groupName,params);
end
...
% UIWAIT makes freqAnalGUI wait for user response (see UIRESUME)
% uiresume is called when user pushes ok or cancel buttons.
% This triggers the output function to return the params.
uiwait(handles.freqAnalFigure);


% --- Outputs from this freqAnalGUI 
function varargout = freqAnalGUI_OutputFcn(hObject, eventdata, handles)
...
% uiresume triggers freqAnalGUI_OutputFcn
uiresume;
